 ...
 * 
 */
public abstract class Baselog_money_used extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("log_money_used");
	...
	static {
		...
		metaData.setTableName("log_money_used");

		metaData.setCluster("DB_LOG");
	}

	public Baselog_money_used() {}

	public Baselog_money_used(Baselog_money_used obj) {
		this.id = obj.id;

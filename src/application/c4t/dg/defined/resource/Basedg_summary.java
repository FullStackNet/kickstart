...
public abstract class Basedg_summary extends BaseResource {
	...
	private Integer number_of_low_battery = null;
	...
	public static String FIELD_TOTAL_DG = "total_dg";
	public static String FIELD_TODAY_FUEL_LOSS = "today_fuel_loss";
	public static String FIELD_CURRENT_MONTH_FUEL_CONSUMED = "current_month_fuel_consumed";
	...
	public static String FIELD_NUMBER_OF_LOW_BATTERY = "number_of_low_battery";
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("dg_summary");
	...
	static {
		...
		Field total_dgField = new Field("total_dg", "int");
		total_dgField.setDefaultValue(0);
		total_dgField.setLength(10);
		metaData.addField(total_dgField);
		...
		Field current_month_fuel_consumedField = new Field("current_month_fuel_consumed", "Number");
		current_month_fuel_consumedField.setDefaultValue(0.00);
		current_month_fuel_consumedField.setLength(20);
		current_month_fuel_consumedField.setPrecision(3);
		metaData.addField(current_month_fuel_consumedField);
		...
		current_month_run_timeField.setDefaultValue(0);
		...
		Field number_of_low_batteryField = new Field("number_of_low_battery", "int");
		number_of_low_batteryField.setDefaultValue(0);
		number_of_low_batteryField.setLength(10);
		metaData.addField(number_of_low_batteryField);
	...
	public Basedg_summary(Basedg_summary obj) {
		...
		this.number_of_low_battery = obj.number_of_low_battery;
	...
	private void setDefaultValues() {
		...
		if(current_month_fuel_consumed == null)
			current_month_fuel_consumed = 0.00;
		...
		if(number_of_low_battery == null)
			number_of_low_battery = 0;
	...
	public Map<String, Object> convertResourceToMap() {
		...
		if(total_dg != null)
			map.put("total_dg", total_dg);
		if(today_fuel_loss != null)
			map.put("today_fuel_loss", today_fuel_loss);
		if(current_month_fuel_consumed != null)
			map.put("current_month_fuel_consumed", current_month_fuel_consumed);
		if(current_month_fuel_loss != null)
		...
		if(number_of_low_battery != null)
			map.put("number_of_low_battery", number_of_low_battery);
		if(number_of_high_water_temp != null)
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		total_dg = (Integer) map.get("total_dg");
		today_fuel_loss = (Number) map.get("today_fuel_loss");
		current_month_fuel_consumed = (Number) map.get("current_month_fuel_consumed");
		...
		number_of_low_battery = (Integer) map.get("number_of_low_battery");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object total_dgObj = map.get("total_dg");
		if(total_dgObj != null)
			total_dg = new Integer(total_dgObj.toString());
		...
		Object current_month_fuel_consumedObj = map.get("current_month_fuel_consumed");
		if(current_month_fuel_consumedObj != null)
			current_month_fuel_consumed = new Double(current_month_fuel_consumedObj.toString());
		...
		Object number_of_low_batteryObj = map.get("number_of_low_battery");
		if(number_of_low_batteryObj != null)
			number_of_low_battery = new Integer(number_of_low_batteryObj.toString());
	...
	public Integer getTotal_dg() {
		return total_dg != null ? total_dg : 0;
	}

	public void setTotal_dg(int total_dg) {
		this.total_dg = total_dg;
	}

	public void setTotal_dg(Integer total_dg) {
		this.total_dg = total_dg;
	}

	public void unSetTotal_dg() {
		this.total_dg = 0;
	}
	...
	public Number getCurrent_month_fuel_consumed() {
		return current_month_fuel_consumed != null ? current_month_fuel_consumed : 0.00;
	}

	public void setCurrent_month_fuel_consumed(Number current_month_fuel_consumed) {
		this.current_month_fuel_consumed = current_month_fuel_consumed;
	}

	public void unSetCurrent_month_fuel_consumed() {
		this.current_month_fuel_consumed = 0.00;
	}
	...
	public Integer getNumber_of_low_battery() {
		return number_of_low_battery != null ? number_of_low_battery : 0;
	}

	public void setNumber_of_low_battery(int number_of_low_battery) {
		this.number_of_low_battery = number_of_low_battery;
	}

	public void setNumber_of_low_battery(Integer number_of_low_battery) {
		this.number_of_low_battery = number_of_low_battery;
	}

	public void unSetNumber_of_low_battery() {
		this.number_of_low_battery = 0;
	}

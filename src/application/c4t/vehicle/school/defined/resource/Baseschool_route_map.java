...
public abstract class Baseschool_route_map extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("school_route_map");
	...
	static {
		...
		metaData.setTableName("school_route_map");

		metaData.setCluster("DB_DEVICE");
	}

	public Baseschool_route_map() {}

	public Baseschool_route_map(Baseschool_route_map obj) {
		this.id = obj.id;

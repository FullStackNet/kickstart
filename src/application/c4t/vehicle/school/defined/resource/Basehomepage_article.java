 ...
 * 
 */
public abstract class Basehomepage_article extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("homepage_article");
	...
	static {
		...
		metaData.setTableName("homepage_article");

		metaData.setCluster("DB_SCHOOL");
	}

	public Basehomepage_article() {}

	public Basehomepage_article(Basehomepage_article obj) {
		this.id = obj.id;

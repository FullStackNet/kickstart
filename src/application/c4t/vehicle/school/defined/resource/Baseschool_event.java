 ...
 * 
 */
public abstract class Baseschool_event extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("school_event");
	...
	static {
		...
		Field event_timeField = new Field("event_time", "String");
		event_timeField.setLength(16);
		...
		metaData.setTableName("school_event");

		metaData.setCluster("DB_SCHOOL");
	}

	public Baseschool_event() {}

	public Baseschool_event(Baseschool_event obj) {
		this.id = obj.id;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		event_time = (String) map.get("event_time");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		if(event_timeObj != null)
			event_time = event_timeObj.toString();

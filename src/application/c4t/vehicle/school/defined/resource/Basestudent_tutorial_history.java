 ...
 * 
 */
public abstract class Basestudent_tutorial_history extends BaseResource {
	...
	private Long sent_assignment_date = null;
	private Long sent_assignment_date_str = null;
	private Long recived_assignment_date = null;
	private Long recived_assigned_date_str = null;
	...
	public static String FIELD_SENT_ASSIGNMENT_DATE = "sent_assignment_date";
	public static String FIELD_SENT_ASSIGNMENT_DATE_STR = "sent_assignment_date_str";
	public static String FIELD_RECIVED_ASSIGNMENT_DATE = "recived_assignment_date";
	public static String FIELD_RECIVED_ASSIGNED_DATE_STR = "recived_assigned_date_str";
	public static String FIELD_CREATION_TIME = "creation_time";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	private final static ResourceMetaData metaData = new ResourceMetaData("student_tutorial_history");
	...
	static {
		...
		Field sent_assignment_dateField = new Field("sent_assignment_date", "timestamp");
		metaData.addField(sent_assignment_dateField);

		Field sent_assignment_date_strField = new Field("sent_assignment_date_str", "timestamp");
		metaData.addField(sent_assignment_date_strField);

		Field recived_assignment_dateField = new Field("recived_assignment_date", "timestamp");
		metaData.addField(recived_assignment_dateField);

		Field recived_assigned_date_strField = new Field("recived_assigned_date_str", "timestamp");
		metaData.addField(recived_assigned_date_strField);
	...
	public Basestudent_tutorial_history(Basestudent_tutorial_history obj) {
		this.id = obj.id;
		...
		this.sent_assignment_date = obj.sent_assignment_date;
		this.sent_assignment_date_str = obj.sent_assignment_date_str;
		this.recived_assignment_date = obj.recived_assignment_date;
		this.recived_assigned_date_str = obj.recived_assigned_date_str;
	...
	public Map<String, Object> convertResourceToMap() {
		...
		if(sent_assignment_date != null)
			map.put("sent_assignment_date", sent_assignment_date);
		if(sent_assignment_date_str != null)
			map.put("sent_assignment_date_str", sent_assignment_date_str);
		if(recived_assignment_date != null)
			map.put("recived_assignment_date", recived_assignment_date);
		if(recived_assigned_date_str != null)
			map.put("recived_assigned_date_str", recived_assigned_date_str);
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		sent_assignment_date = (Long) map.get("sent_assignment_date");
		sent_assignment_date_str = (Long) map.get("sent_assignment_date_str");
		recived_assignment_date = (Long) map.get("recived_assignment_date");
		recived_assigned_date_str = (Long) map.get("recived_assigned_date_str");
	...
	public Long getSent_assignment_date() {
		return sent_assignment_date;
	}

	public void setSent_assignment_date(Long sent_assignment_date) {
		this.sent_assignment_date = sent_assignment_date;
	}


	public Long getSent_assignment_date_str() {
		return sent_assignment_date_str;
	}

	public void setSent_assignment_date_str(Long sent_assignment_date_str) {
		this.sent_assignment_date_str = sent_assignment_date_str;
	}


	public Long getRecived_assignment_date() {
		return recived_assignment_date;
	}

	public void setRecived_assignment_date(Long recived_assignment_date) {
		this.recived_assignment_date = recived_assignment_date;
	}


	public Long getRecived_assigned_date_str() {
		return recived_assigned_date_str;
	}

	public void setRecived_assigned_date_str(Long recived_assigned_date_str) {
		this.recived_assigned_date_str = recived_assigned_date_str;
	}

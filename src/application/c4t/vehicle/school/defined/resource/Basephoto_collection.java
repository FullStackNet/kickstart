...
public abstract class Basephoto_collection extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("photo_collection");
	...
	static {
		...
		metaData.setTableName("photo_collection");

		metaData.setCluster("DB_SCHOOL");
	}

	public Basephoto_collection() {}

	public Basephoto_collection(Basephoto_collection obj) {
		this.id = obj.id;

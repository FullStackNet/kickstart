 ...
 * 
 */
public abstract class Basevideo_collection extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("video_collection");
	...
	static {
		...
		metaData.setTableName("video_collection");

		metaData.setCluster("DB_SCHOOL");
	}

	public Basevideo_collection() {}

	public Basevideo_collection(Basevideo_collection obj) {
		this.id = obj.id;

...
public abstract class BaseMOConfigureNotificationManager extends Message {
	...
	public BaseMOConfigureNotificationManager() {
		super();
		setCategory((byte)6);
		setCommand((byte)18);
	...
	public void convertMapToMessage(Map<String, Object> map) {
 	...
 	public String getName() {return "MOConfigureNotificationManager";}

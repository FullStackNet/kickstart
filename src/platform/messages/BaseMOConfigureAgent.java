...
public abstract class BaseMOConfigureAgent extends Message {
	...
	public void populate_field() {
		...
		fields[4] =  new Field("db_enable","String",1);
	}
	...
	public void convertMapToMessage(Map<String, Object> map) {
 	...
 	public int getMessageSize() {return 513;}

 	public String getName() {return "MOConfigureAgent";}

...
public abstract class Basec4t_transient_object extends BaseResource {
	...
	private Long counter_1 = null;
	private Long counter_2 = null;
	private Long counter_3 = null;
	private Long counter_4 = null;
	private Long counter_5 = null;
	private Double dcounter_1 = null;
	private Double dcounter_2 = null;
	private Double dcounter_3 = null;
	private Double dcounter_4 = null;
	private Double dcounter_5 = null;
	...
	public static String FIELD_COUNTER_1 = "counter_1";
	public static String FIELD_COUNTER_2 = "counter_2";
	public static String FIELD_COUNTER_3 = "counter_3";
	public static String FIELD_COUNTER_4 = "counter_4";
	public static String FIELD_COUNTER_5 = "counter_5";
	public static String FIELD_DCOUNTER_1 = "dcounter_1";
	public static String FIELD_DCOUNTER_2 = "dcounter_2";
	public static String FIELD_DCOUNTER_3 = "dcounter_3";
	public static String FIELD_DCOUNTER_4 = "dcounter_4";
	public static String FIELD_DCOUNTER_5 = "dcounter_5";
	...
	static {
		...
		Field counter_1Field = new Field("counter_1", "long");
		metaData.addField(counter_1Field);

		Field counter_2Field = new Field("counter_2", "long");
		metaData.addField(counter_2Field);

		Field counter_3Field = new Field("counter_3", "long");
		metaData.addField(counter_3Field);

		Field counter_4Field = new Field("counter_4", "long");
		metaData.addField(counter_4Field);

		Field counter_5Field = new Field("counter_5", "long");
		metaData.addField(counter_5Field);

		Field dcounter_1Field = new Field("dcounter_1", "double");
		metaData.addField(dcounter_1Field);

		Field dcounter_2Field = new Field("dcounter_2", "double");
		metaData.addField(dcounter_2Field);

		Field dcounter_3Field = new Field("dcounter_3", "double");
		metaData.addField(dcounter_3Field);

		Field dcounter_4Field = new Field("dcounter_4", "double");
		metaData.addField(dcounter_4Field);

		Field dcounter_5Field = new Field("dcounter_5", "double");
		metaData.addField(dcounter_5Field);
	...
	public Basec4t_transient_object(Basec4t_transient_object obj) {
		...
		this.counter_1 = obj.counter_1;
		this.counter_2 = obj.counter_2;
		this.counter_3 = obj.counter_3;
		this.counter_4 = obj.counter_4;
		this.counter_5 = obj.counter_5;
		this.dcounter_1 = obj.dcounter_1;
		this.dcounter_2 = obj.dcounter_2;
		this.dcounter_3 = obj.dcounter_3;
		this.dcounter_4 = obj.dcounter_4;
		this.dcounter_5 = obj.dcounter_5;
		this.dob = obj.dob;
	...
	public Map<String, Object> convertResourceToMap() {
		...
		if(counter_1 != null)
			map.put("counter_1", counter_1);
		if(counter_2 != null)
			map.put("counter_2", counter_2);
		if(counter_3 != null)
			map.put("counter_3", counter_3);
		if(counter_4 != null)
			map.put("counter_4", counter_4);
		if(counter_5 != null)
			map.put("counter_5", counter_5);
		if(dcounter_1 != null)
			map.put("dcounter_1", dcounter_1);
		if(dcounter_2 != null)
			map.put("dcounter_2", dcounter_2);
		if(dcounter_3 != null)
			map.put("dcounter_3", dcounter_3);
		if(dcounter_4 != null)
			map.put("dcounter_4", dcounter_4);
		if(dcounter_5 != null)
			map.put("dcounter_5", dcounter_5);
		if(dob != null)
			map.put("dob", dob);
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		counter_1 = (Long) map.get("counter_1");
		counter_2 = (Long) map.get("counter_2");
		counter_3 = (Long) map.get("counter_3");
		counter_4 = (Long) map.get("counter_4");
		counter_5 = (Long) map.get("counter_5");
		dcounter_1 = (Double) map.get("dcounter_1");
		dcounter_2 = (Double) map.get("dcounter_2");
		dcounter_3 = (Double) map.get("dcounter_3");
		dcounter_4 = (Double) map.get("dcounter_4");
		dcounter_5 = (Double) map.get("dcounter_5");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object counter_1Obj = map.get("counter_1");
		if(counter_1Obj != null)
			counter_1 = new Long(counter_1Obj.toString());

		Object counter_2Obj = map.get("counter_2");
		if(counter_2Obj != null)
			counter_2 = new Long(counter_2Obj.toString());

		Object counter_3Obj = map.get("counter_3");
		if(counter_3Obj != null)
			counter_3 = new Long(counter_3Obj.toString());

		Object counter_4Obj = map.get("counter_4");
		if(counter_4Obj != null)
			counter_4 = new Long(counter_4Obj.toString());

		Object counter_5Obj = map.get("counter_5");
		if(counter_5Obj != null)
			counter_5 = new Long(counter_5Obj.toString());

		Object dcounter_1Obj = map.get("dcounter_1");
		if(dcounter_1Obj != null)
			dcounter_1 = new Double(dcounter_1Obj.toString());

		Object dcounter_2Obj = map.get("dcounter_2");
		if(dcounter_2Obj != null)
			dcounter_2 = new Double(dcounter_2Obj.toString());

		Object dcounter_3Obj = map.get("dcounter_3");
		if(dcounter_3Obj != null)
			dcounter_3 = new Double(dcounter_3Obj.toString());

		Object dcounter_4Obj = map.get("dcounter_4");
		if(dcounter_4Obj != null)
			dcounter_4 = new Double(dcounter_4Obj.toString());

		Object dcounter_5Obj = map.get("dcounter_5");
		if(dcounter_5Obj != null)
			dcounter_5 = new Double(dcounter_5Obj.toString());
	...
	public Long getCounter_1() {
		return counter_1;
	}

	public long getCounter_1Ex() {
		return counter_1 != null ? counter_1 : 0L;
	}

	public void setCounter_1(long counter_1) {
	...
	public void unSetCounter_1() {
		this.counter_1 = null;
	}

	public Long getCounter_2() {
		return counter_2;
	}

	public long getCounter_2Ex() {
		return counter_2 != null ? counter_2 : 0L;
	}

	public void setCounter_2(long counter_2) {
	...
	public void unSetCounter_2() {
		this.counter_2 = null;
	}

	public Long getCounter_3() {
		return counter_3;
	}

	public long getCounter_3Ex() {
		return counter_3 != null ? counter_3 : 0L;
	}

	public void setCounter_3(long counter_3) {
	...
	public void unSetCounter_3() {
		this.counter_3 = null;
	}

	public Long getCounter_4() {
		return counter_4;
	}

	public long getCounter_4Ex() {
		return counter_4 != null ? counter_4 : 0L;
	}

	public void setCounter_4(long counter_4) {
	...
	public void unSetCounter_4() {
		this.counter_4 = null;
	}

	public Long getCounter_5() {
		return counter_5;
	}

	public long getCounter_5Ex() {
		return counter_5 != null ? counter_5 : 0L;
	}

	public void setCounter_5(long counter_5) {
		this.counter_5 = counter_5;
	}
	...
	public void unSetCounter_5() {
		this.counter_5 = null;
	}

	public Double getDcounter_1() {
		return dcounter_1;
	}

	public double getDcounter_1Ex() {
		return dcounter_1 != null ? dcounter_1 : 0;
	}

	public void setDcounter_1(double dcounter_1) {
		this.dcounter_1 = dcounter_1;
	}
	...
	public void unSetDcounter_1() {
		this.dcounter_1 = null;
	}

	public Double getDcounter_2() {
		return dcounter_2;
	}

	public double getDcounter_2Ex() {
		return dcounter_2 != null ? dcounter_2 : 0;
	}

	public void setDcounter_2(double dcounter_2) {
		this.dcounter_2 = dcounter_2;
	}
	...
	public void unSetDcounter_2() {
		this.dcounter_2 = null;
	}

	public Double getDcounter_3() {
		return dcounter_3;
	}

	public double getDcounter_3Ex() {
		return dcounter_3 != null ? dcounter_3 : 0;
	}

	public void setDcounter_3(double dcounter_3) {
		this.dcounter_3 = dcounter_3;
	}
	...
	public void unSetDcounter_3() {
		this.dcounter_3 = null;
	}

	public Double getDcounter_4() {
		return dcounter_4;
	}

	public double getDcounter_4Ex() {
		return dcounter_4 != null ? dcounter_4 : 0;
	}

	public void setDcounter_4(double dcounter_4) {
		this.dcounter_4 = dcounter_4;
	}
	...
	public void unSetDcounter_4() {
		this.dcounter_4 = null;
	}

	public Double getDcounter_5() {
		return dcounter_5;
	}

	public double getDcounter_5Ex() {
		return dcounter_5 != null ? dcounter_5 : 0;
	}

	public void setDcounter_5(double dcounter_5) {
		this.dcounter_5 = dcounter_5;
	}
	...
	public void unSetDcounter_5() {
		this.dcounter_5 = null;
	}

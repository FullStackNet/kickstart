 ...
 * 
 */
public abstract class Basehardware_vendor extends BaseResource {
	...
	static {
		...
		Field short_codeField = new Field("short_code", "String");
		short_codeField.setRequired(true);
		short_codeField.setLength(10);
		metaData.addField(short_codeField);
	...
	public Basehardware_vendor() {}

	public Basehardware_vendor(Basehardware_vendor obj) {
		this.id = obj.id;
		this.name = obj.name;
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object short_codeObj = map.get("short_code");
	...
	public String getShort_codeEx() {
		return short_code != null ? short_code : "";
	}
	...
	public void unSetShort_code() {
		this.short_code = null;
	}

	public boolean validateShort_code(boolean add) throws ApplicationException {
		if(add && short_code == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[short_code]");

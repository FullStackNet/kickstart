...
public class MQTTConnector {
	...
	public MQTTConnector(String connectURL, String name, String userName, String password, MessageManager messageManager) {
	...
	class MQTTMessageProcessingTask implements Runnable {
		platform.communication.Session session;
		platform.message.Message message;
		
		public MQTTMessageProcessingTask(platform.communication.Session session , platform.message.Message message) {
      ...
      try {
			...
			consumer.setMessageListener(new MessageListener() {
				...
				public void onMessage(javax.jms.Message message) {
					...
					pool.addTask(new MQTTMessageProcessingTask(cr4Session, msg));
				}
			});

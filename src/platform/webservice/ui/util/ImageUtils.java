...
public class ImageUtils {
	...
	public final static String C2P_HEADER_LOGO = IMAGE_PATH+"c2p_logo.jpg";
	public final static String C22_HEADER_LOGO = IMAGE_PATH+"c2c_new_logo.png";
	...
	public final static String TAB_ACTIVITY = IMAGE_PATH+"tabactivity.png";

...
public class CorporateTestHeaderView extends BaseView {
	UIServletContext mContext;
	public CorporateTestHeaderView(UIServletContext context) {
		mContext = context;
	}
	...
	public void buildUI() {
		...
		a = new A();	
		a.setText("Home");
		a.setHref("/ui/corporate_test_myarea");
		li.addChild(a);
		
		li = new LI();
		ul.addChild(li);
		a = new A();	
		a.setHref("/ui/corporate_test_logout");
		a.setText("Logout");
		li.addChild(a);		

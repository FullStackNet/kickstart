...
public class CoachingCreateMenuView extends BaseView {
	UIServletContext mContext;
	public CoachingCreateMenuView(UIServletContext context) {
		mContext = context;
	}
	...
	*/
	public void buildUI() {
		...
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-cubes\"></i></div><div>Create Test Series</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-cloud-upload\"></i></div><div>Share Material</div>");
		li.addChild(a);
		...
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-users\"></i></div><div> Create New Batch</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-user\"></i></div><div> Create Student</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-user\"></i></div><div> Create Teacher</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-bullhorn\"></i></div><div> Create Annoucement</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-newspaper-o\"></i></div><div> Create Current Affair</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-youtube-play\"></i></div><div> Share Video</div>");
		li.addChild(a);

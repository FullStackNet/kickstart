...
public class MOBDWriter extends Writer {

	char startchar;
	public MOBDWriter(char startChar) {
	...
	public String getPacket(Session session,Message message) {
		...
		payload.append(","+Integer.toHexString(message.getCategory()).toUpperCase()+Util.hexString(message.getCommand()));

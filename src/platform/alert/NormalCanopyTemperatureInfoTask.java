...
public class NormalCanopyTemperatureInfoTask extends AlertTask {

	public NormalCanopyTemperatureInfoTask() {
		super(AlertFactory.ALERT_NORMAL_CANOPY_TEMPERATURE);

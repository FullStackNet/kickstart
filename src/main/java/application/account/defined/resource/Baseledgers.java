...
public abstract class Baseledgers extends BaseResource {
    ...
    private List<application.account.resource.account> ledgers = null;
    ...
    public void convertMapToResource(Map<String, Object> map) {
        ...
        ledgers = (List<application.account.resource.account>) map.get("ledgers");
    ...
    public List<application.account.resource.account> getLedgers() {
        return ledgers;
    }


    public void setLedgers(List<application.account.resource.account> ledgers) {
        this.ledgers = ledgers;
    }

    public void addLedgers(application.account.resource.account value) {
        if (ledgers == null)
            ledgers = new ArrayList<application.account.resource.account>();
        ledgers.add(value);
    }

 ...
 * 
 */
public abstract class Basecourse_category extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("course_category");
	...
	static {
		...
		metaData.setTableName("course_category");

		metaData.setCluster("DB_SCHOOL");
	}

	public Basecourse_category() {}

	public Basecourse_category(Basecourse_category obj) {
		this.id = obj.id;
	...
	public boolean validateParent_name(boolean add) throws ApplicationException {

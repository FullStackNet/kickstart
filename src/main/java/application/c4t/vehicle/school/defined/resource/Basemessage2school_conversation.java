 ...
 * 
 */
public abstract class Basemessage2school_conversation extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("message2school_conversation");
	...
	static {
		...
		metaData.setTableName("message2school_conversation");

		metaData.setCluster("DB_SCHOOL");
	}

	public Basemessage2school_conversation() {}

	public Basemessage2school_conversation(Basemessage2school_conversation obj) {
		this.id = obj.id;

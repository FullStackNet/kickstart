 ...
 * 
 */
public abstract class Basehomepage_current_affair extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("homepage_current_affair");
	...
	static {
		...
		metaData.setTableName("homepage_current_affair");

		metaData.setCluster("DB_SCHOOL");
	}

	public Basehomepage_current_affair() {}

	public Basehomepage_current_affair(Basehomepage_current_affair obj) {
		this.id = obj.id;

 ...
 * 
 */
public abstract class Basemessage2parent_conversation extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("message2parent_conversation");
	...
	static {
		...
		metaData.setTableName("message2parent_conversation");

		metaData.setCluster("DB_SCHOOL");
	}

	public Basemessage2parent_conversation() {}

	public Basemessage2parent_conversation(Basemessage2parent_conversation obj) {
		this.id = obj.id;

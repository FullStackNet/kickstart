 ...
 * 
 */
public abstract class Basevideo extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("video");
	...
	public Basevideo(Basevideo obj) {
		this.id = obj.id;

 ...
 * 
 */
public abstract class Basemessage2school extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("message2school");
	...
	static {
		...
		metaData.setTableName("message2school");

		metaData.setCluster("DB_SCHOOL");
	}

	public Basemessage2school() {}

	public Basemessage2school(Basemessage2school obj) {
		this.id = obj.id;

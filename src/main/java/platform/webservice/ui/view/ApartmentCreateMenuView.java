...
public class ApartmentCreateMenuView extends BaseView {
	UIServletContext mContext;
	public ApartmentCreateMenuView(UIServletContext context) {
		mContext = context;
	}
	...
	*/
	public void buildUI() {
		...
		a.setText("<div><i class=\"fa fa-laptop\"></i></div><div>Create Meeting </div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-cubes\"></i></div><div>Create Notice</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-cloud-upload\"></i></div><div>Create Poll</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-institution\"></i></div><div>Create Invoice</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-users\"></i></div><div> Create Receipt</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-user\"></i></div><div> Create Discussion</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-user\"></i></div><div> Create Event</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-bullhorn\"></i></div><div> Create Member</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-newspaper-o\"></i></div><div> Create Group</div>");
		li.addChild(a);
		
		li = new LI(null,"");
		ul.addChild(li);
		a = new A();
		a.setText("<div><i class=\"fa fa-newspaper-o\"></i></div><div> Create Album</div>");
		li.addChild(a);

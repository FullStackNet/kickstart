...
public abstract class ApartmentThreeColumnDBApplicationServlet extends BaseUIServlet {
	/**
	 * 
	 */
	...
	public String getWebPage(UIServletContext context) {
		...
		// TODO Auto-generated method stub
		ApartmentThreeColumnLayout layout = new ApartmentThreeColumnLayout(context);

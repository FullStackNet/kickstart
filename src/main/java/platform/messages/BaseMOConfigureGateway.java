...
public abstract class BaseMOConfigureGateway extends Message {
	...
	private String db_enable = null;


	public BaseMOConfigureGateway() {
		super();
		setCategory((byte)6);
		setCommand((byte)10);
	...
	public void populate_field() {
		...
		fields[4] =  new Field("modules","String",128);
		fields[5] =  new Field("db_enable","String",1);
	}
	...
	public void dump() {
		...
		System.out.println("db_enable	:	 "+db_enable);
	}
	...
	public void convertMapToMessage(Map<String, Object> map) {
		...
		db_enable = (String) map.get("db_enable");
	}

 	public int getMessageSize() {return 641;}

 	public String getName() {return "MOConfigureGateway";}
...
public Message process(Session session,Message parentMessage) {return null;}
	...
	public String getDb_enable() {
		return db_enable;
	}

	public String getDb_enableEx() {
		return db_enable != null ? db_enable : "";
	}

	public void setDb_enable(String db_enable) {
		this.db_enable = db_enable;
	}

	public void unSetDb_enable() {
		this.db_enable = null;
	}
}
...
public abstract class Baseappliance_simulator extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("appliance_simulator");
	...
	static {
		...
		metaData.setTableName("appliance_simulator");

		metaData.setCluster("DB_DEVICE");
	}

	public Baseappliance_simulator() {}

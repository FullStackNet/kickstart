 ...
 * 
 */
public abstract class Basebilling_slab_master extends BaseResource {
	private String id = null;
	private String name = null;
	private String source = null; //DG/GRID
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("billing_slab_master");
	...
	static {
		...
		metaData.setTableName("billing_slab_master");

		metaData.setCluster("DB_PROFILE");
	}

	public Basebilling_slab_master() {}

	public Basebilling_slab_master(Basebilling_slab_master obj) {
		this.id = obj.id;
		this.name = obj.name;

 ...
 * 
 */
public abstract class Basemeter_hourly_log extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("meter_hourly_log");
	...
	static {
		...
		log_date_strField.setLength(128);
		...
		metaData.setTableName("meter_hourly_log");

		metaData.setCluster("DB_ANALYSIS");
	}

	public Basemeter_hourly_log() {}

	public Basemeter_hourly_log(Basemeter_hourly_log obj) {
		this.id = obj.id;

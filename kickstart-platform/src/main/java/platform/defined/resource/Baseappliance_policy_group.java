 ...
 * 
 */
public abstract class Baseappliance_policy_group extends BaseResource {
	...
	public Baseappliance_policy_group() {}

	public Baseappliance_policy_group(Baseappliance_policy_group obj) {
		this.id = obj.id;
		this.name = obj.name;

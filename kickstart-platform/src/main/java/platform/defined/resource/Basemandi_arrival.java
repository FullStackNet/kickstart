...
public abstract class Basemandi_arrival extends BaseResource {
	...
	public static String FIELD_SOLD = "sold";
	...
	static {
		...
		Field soldField = new Field("sold", "int");
		metaData.addField(soldField);
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object soldObj = map.get("sold");
		if(soldObj != null)
			sold = new Integer(soldObj.toString());

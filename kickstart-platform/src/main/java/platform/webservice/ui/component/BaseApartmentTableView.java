...
public abstract class BaseApartmentTableView extends BaseView {
	...
	public BaseApartmentTableView(UIServletContext ctx,TableDefinition definition) {
		super();
		mContext = ctx;
	...
	public BaseApartmentTableView(UIServletContext ctx) {
		super();
		mContext = ctx;
		ctx.getPageBuilder().addJS(new JS("action_handle.js", "/ui/js/"));
		fromDatestring = (String) getContext().getParamValue("from_date");

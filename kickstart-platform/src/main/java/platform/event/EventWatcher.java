...
public class EventWatcher {
    ...
    private synchronized void registerEventListener(Class<? extends Event> event, Condition _condition) {
        createEventListener();

        if (_condition != null) {
            eventManager.registerEventListener(eventListener, eventClass, _condition);
        } else {

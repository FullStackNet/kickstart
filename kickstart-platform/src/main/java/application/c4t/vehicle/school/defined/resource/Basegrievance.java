 ...
 * 
 */
public abstract class Basegrievance extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("grievance");
	...
	static {
		...
		metaData.setTableName("grievance");

		metaData.setCluster("DB_SCHOOL");
	}

	public Basegrievance() {}

	public Basegrievance(Basegrievance obj) {
		this.id = obj.id;

 ...
 * 
 */
public abstract class Basesubject_topic extends BaseResource {
	...
	private final static ResourceMetaData metaData = new ResourceMetaData("subject_topic");
	...
	static {
		...
		metaData.setTableName("subject_topic");

		metaData.setCluster("DB_CONFIG");
	}

	public Basesubject_topic() {}

	public Basesubject_topic(Basesubject_topic obj) {
		this.id = obj.id;
		this.name = obj.name;
